         ...
         <section className="py-8 sm:py-12 w-full bg-white">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
               ...
               <div className="text-center mb-6 sm:mb-8">
                  <h1 className="text-xl sm:text-2xl md:text-3xl font-semibold text-gray-900 tracking-tight">About BrightBridge</h1>
                  ...
                  <div className="lg:col-span-2">
                     <div className="bg-white rounded-2xl shadow-sm p-4 sm:p-6 border border-gray-100">
                        <div className="flex items-center mb-6 sm:mb-8">
                           ...
                           <h2 className="text-base sm:text-lg md:text-xl font-semibold text-gray-900 ml-3 sm:ml-4">Benefits of working with us</h2>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                           <div className="group bg-gradient-to-br from-indigo-50 to-blue-50 p-4 sm:p-6 rounded-2xl hover:shadow-lg transition-all duration-300">
                              <div className="flex items-start gap-3 sm:gap-4">
                                 ...
                                 <div>
                                    <h3 className="text-sm sm:text-base font-semibold text-gray-900 mb-2">Ethical design practices</h3>
                           ...
                           <div className="group bg-gradient-to-br from-green-50 to-emerald-50 p-4 sm:p-6 rounded-2xl hover:shadow-lg transition-all duration-300">
                              <div className="flex items-start gap-3 sm:gap-4">
                                 ...
                                 <div>
                                    <h3 className="text-sm sm:text-base font-semibold text-gray-900 mb-2">Performance-minded front-ends</h3>
                           ...
                           <div className="group bg-gradient-to-br from-purple-50 to-pink-50 p-4 sm:p-6 rounded-2xl hover:shadow-lg transition-all duration-300">
                              <div className="flex items-start gap-3 sm:gap-4">
                                 ...
                                 <div>
                                    <h3 className="text-sm sm:text-base font-semibold text-gray-900 mb-2">Client-first collaboration</h3>
                           ...
                           <div className="group bg-gradient-to-br from-orange-50 to-red-50 p-4 sm:p-6 rounded-2xl hover:shadow-lg transition-all duration-300">
                              <div className="flex items-start gap-3 sm:gap-4">
                                 ...
                                 <div>
                                    <h3 className="text-sm sm:text-base font-semibold text-gray-900 mb-2">Documented handoffs</h3>
                           ...
                           <div className="group bg-gradient-to-br from-teal-50 to-cyan-50 p-4 sm:p-6 rounded-2xl hover:shadow-lg transition-all duration-300">
                              <div className="flex items-start gap-3 sm:gap-4">
                                 ...
                                 <div>
                                    <h3 className="text-sm sm:text-base font-semibold text-gray-900 mb-2">Accessibility-focused development</h3>
                           ...
                           <div className="group bg-gradient-to-br from-blue-50 to-indigo-50 p-4 sm:p-6 rounded-2xl hover:shadow-lg transition-all duration-300">
                              <div className="flex items-start gap-3 sm:gap-4">
                                 ...
                                 <div>
                                    <h3 className="text-sm sm:text-base font-semibold text-gray-900 mb-2">Modern and clean code</h3>
                  ...
                  <div className="lg:col-span-1">
                     <div className="bg-white rounded-2xl shadow-sm p-4 sm:p-6 border border-gray-100 sticky top-20 sm:top-24">
                        <div className="flex items-center mb-4 sm:mb-6">
                           ...
                           <h2 className="text-lg sm:text-xl font-semibold text-gray-900 ml-3 sm:ml-4">Contact</h2>
                        </div>

                        <p className="text-xs sm:text-sm text-gray-600 mb-6 sm:mb-8">For inquiries, email: <a className="text-indigo-600 hover:underline font-semibold" href={`mailto:${contactInfo.email}`}>{contactInfo.email}</a></p>
                        ...
                        <div className="space-y-4 sm:space-y-6">
                           <div className="flex items-start gap-3 sm:gap-4">
                              ...
                              <div>
                                 ...
                                 <div className="text-xs sm:text-sm text-gray-900 font-semibold">{contactInfo.address}</div>
                              </div>
                           </div>
                           ...
                           <div className="flex items-start gap-3 sm:gap-4">
                              ...
                              <div>
                                 ...
                                 <div className="text-xs sm:text-sm text-gray-900 font-semibold">{contactInfo.phone}</div>
                              </div>
                           </div>
                           ...
                           <div className="flex items-start gap-3 sm:gap-4">
                              ...
                              <div>
                                 ...
                                 <div className="text-xs sm:text-sm text-gray-900 font-semibold">
                                    <a className="text-indigo-600 hover:underline" href={`mailto:${contactInfo.email}`}>{contactInfo.email}</a>
                                 </div>
                              </div>
                           </div>
                        </div>
