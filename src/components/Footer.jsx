            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
               ...
               <div className="lg:col-span-2">
                  <div className="flex items-center mb-6">
                     ...
                     <h3 className="text-2xl font-bold text-white ml-4">BrightBridge</h3>
                  </div>
                  ...
                  <div className="flex space-x-4">
                     <a href="#" className="p-3 bg-gray-800 rounded-xl hover:bg-indigo-600 transition-all duration-300 transform hover:scale-110 shadow-lg hover:shadow-xl">
                  ...
                  <div className="space-y-4">
                     <div className="flex items-start gap-3">
                        ...
                        <div>
                           ...
                           <a href="mailto:hello@brightbridge.com" className="text-white hover:text-indigo-400 transition-colors duration-300">hello@brightbridge.com</a>
                        </div>
                     </div>
                     <div className="flex items-start gap-3">
                        ...
                        <div>
                           ...
                           <a href="tel:+15551234567" className="text-white hover:text-green-400 transition-colors duration-300">(555) 123-4567</a>
                        </div>
                     </div>
                     <div className="flex items-start gap-3">
                        ...
                        <div>
                           ...
                           <p className="text-white">123 Business Street<br />City, State 12345</p>
                        </div>
                     </div>
                  </div>
               </div>
